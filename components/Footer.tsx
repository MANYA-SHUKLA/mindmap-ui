    ...
    <footer className="absolute bottom-0 left-0 right-0 z-30 bg-gradient-to-r from-indigo-500/90 via-purple-500/90 to-pink-500/90 dark:from-indigo-600/90 dark:via-purple-600/90 dark:to-pink-600/90 backdrop-blur-xl border-t-2 border-white/20 dark:border-gray-700/30 shadow-2xl">
      <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          {/* Made with love text */}
          <div className="flex items-center gap-1.5 sm:gap-2 text-white/90 flex-wrap justify-center sm:justify-start">
            ...
            <span className="font-bold bg-gradient-to-r from-yellow-200 to-yellow-400 bg-clip-text text-transparent text-xs sm:text-sm">
              Manya Shukla
            </span>
          ...
          <div className="flex items-center gap-2 sm:gap-4 flex-wrap justify-center">
            ...
            <a
              ...
              className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/20 hover:bg-white/30 rounded-full text-white text-xs sm:text-sm font-medium transition-all duration-200 hover:scale-110 hover:shadow-lg backdrop-blur-sm border border-white/30"
            >
              <svg
                className="w-4 h-4"
                fill="none"
